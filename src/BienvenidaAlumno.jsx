...
import "./BienvenidaAlumno.css";

/**
 * COMPONENTE BIENVENIDAALUMNO
 * Qué hace: Renderiza la pantalla de bienvenida personalizada para estudiantes (Alumnos)
 ...
 * 
 * Retorna: JSX con la pantalla de bienvenida para Alumnos
 */
function BienvenidaAlumno({ Cerrar, usuario }) {
    ...
    return (
        <div className="pantalla-bienvenida-alumno">
